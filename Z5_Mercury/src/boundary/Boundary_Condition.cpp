...
void MercuryBoundary::BC_Pole_Eedge_Average_Axis(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
...
void MercuryBoundary::BC_Pole_Eedge_Axis(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
    // ---------------------------------------------------------------------
    // Purpose:
...
void MercuryBoundary::BC_Pole_Eedge_Zero_Rotate(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
    const Box3 &inner = r.inner_slab;
...
void MercuryBoundary::BC_Pole_Eedge_RegulateK_Norm(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
    const Box3 &inner = r.inner_slab;
